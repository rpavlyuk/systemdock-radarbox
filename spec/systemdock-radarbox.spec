...
Summary:	SystemDock profile to run radarbox container as systemd service

Group:		Tools/Other
License:	GPLv3
URL:		https://github.com/rpavlyuk/docker-radarbox
...
%description
SystemDock profile to run radarbox container as systemd service
